...
func init() {
	dynamicStrategies[dynamicStrategyKey("Hash", "merge")] = &hashMergeStrategy{}
	dynamicStrategies[dynamicStrategyKey("Hash", "merge!")] = &hashDestructionMergeStrategy{}
	dynamicStrategies[dynamicStrategyKey("Hash", "shift")] = &hashShiftStrategy{}
}
